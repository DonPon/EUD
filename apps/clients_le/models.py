...
class LE_BankingRelationship(ClientRelatedModel):
    ...
    segment_type = models.CharField(max_length=255, choices=SEGMENT_TYPE_CHOICES, null=True, blank=True, verbose_name="Client Type")
...
class LE_Company(ClientRelatedModel):
    ...
    fiscal_code_it = models.CharField(max_length=255, null=True, blank=True, verbose_name="Fiscal Code (IT)")
