...
from .views import LE_ClientListView, LE_ClientDetailView, BulkStatusUpdateLEView, LE_CompleteReviewView, BulkDeleteLEView
...
urlpatterns = [
    ...
    path('bulk-delete/', BulkDeleteLEView.as_view(), name='bulk-delete'),
